...
@NoArgsConstructor
public class CustomerReal extends CustomerCopy {
...
//    @Size(min = 1, max = 10, message = "{validation.zipCode.Size.message}")
    ...
    public CustomerReal(String firstName, String lastName, DateTime birthDate, int partySize, String description,
                        byte[] photo ) {
    ...
    public void becomeNull(CustomerCopy context){
        ...
        context.setCustomerState(CustomerNull.getInstance());
    }
